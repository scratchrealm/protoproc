...
@click.group(help="protoproc command line interface")
def main():
    pass
...
@click.command(help='Handle a job by interacting with the protoproc REST API (used internally)')
