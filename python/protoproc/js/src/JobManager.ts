...
import { GetJobRequest, ProtoprocResponse } from "./types/ProtoprocRequest";
...
class JobManager {
    ...
    async initiateJob(job: ProtoprocJob): Promise<boolean> {
    ...
    // private async _initiatePythonJob(job: ProtoprocJob): Promise<boolean> {
    ...
    //     return okay
    // }
    // private async _initiateSpaJob(job: ProtoprocJob): Promise<boolean> {
...
export class RunningJob {
    ...
    #stopped = false
    constructor(private dir: string, public job: ProtoprocJob) {
    }
    ...
    private async _postProtoprocRequest(req: any): Promise<ProtoprocResponse> {
