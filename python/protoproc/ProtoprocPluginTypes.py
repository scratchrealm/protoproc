...
class ProtoprocProcessingToolContext(ABC):
    @abstractmethod
...
class ProtoprocProcessingTool(ABC):
    @classmethod
    @abstractmethod
    ...
    @classmethod
    @abstractmethod
    def run(cls, context: ProtoprocProcessingToolContext):
        pass
...
class ProtoprocPluginContext(ABC):
    """The plugin context to be passed into the initialize method of the plugin
    """
    @abstractmethod
    def register_processing_tool(self, tool: ProtoprocProcessingTool):
        """Register a processing tool for the plugin

        Args:
            tool (ProtoprocProcessingTool): the processing tool to register
        """
        pass

class ProtoprocPlugin:
    @classmethod
    @abstractmethod
