...
from ...ProtoprocPluginTypes import ProtoprocProcessingTool, ProtoprocProcessingToolContext, InputFile, OutputFile
import pynwb
import h5py
import remfile
...
class Mountainsort5ProcessingTool(ProtoprocProcessingTool):
    @classmethod
...
def _run(context: ProtoprocProcessingToolContext):
