...
def npm_install_command(command_subclass):
    ...
    def modified_run(self):
        ...
        if os.name == 'nt':
            ...
            shell = False
        subprocess.check_call(['npm', 'install'], cwd=f'{this_directory}/protoproc/js', shell=shell)
        subprocess.check_call(['npm', 'run', 'build'], cwd=f'{this_directory}/protoproc/js', shell=shell)
        orig_run(self)
...
setup(
    ...
    url="https://github.com/scratchrealm/protoproc",
