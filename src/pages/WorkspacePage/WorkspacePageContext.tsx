...
import { ComputeResourceSpec, ProtoprocProject, ProtoprocWorkspace } from '../../types/protoproc-types';
...
type WorkspacePageContextType = {
    workspaceId: string
    workspace: ProtoprocWorkspace | undefined
...
export const SetupWorkspacePage: FunctionComponent<PropsWithChildren<Props>> = ({children, workspaceId}) => {
    const [projects, setProjects] = React.useState<ProtoprocProject[] | undefined>(undefined)
    const [workspace, setWorkspace] = React.useState<ProtoprocWorkspace | undefined>(undefined)
