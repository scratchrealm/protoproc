...
import { ProtoprocProcessingJobDefinition } from "../../../../dbInterface/dbInterface";
import { RemoteH5File } from "../../../../RemoteH5File/RemoteH5File";
import { ProcessingToolSchema } from "../../../../types/protoproc-types";
...
type EditJobDefinitionWindowProps = {
    jobDefinition: ProtoprocProcessingJobDefinition | undefined
    setJobDefinition: (jobDefinition: ProtoprocProcessingJobDefinition | undefined) => void
    processingTool: {
        name: string
        attributes: any
        tags: string[]
...
const EditJobDefinitionWindow: FunctionComponent<EditJobDefinitionWindowProps> = ({jobDefinition, setJobDefinition, processingTool, nwbFile}) => {
    ...
    const setParameterValue = useCallback((name: string, value: any) => {
        ...
        const newJobDefinition: ProtoprocProcessingJobDefinition = {
            ...jobDefinition,
