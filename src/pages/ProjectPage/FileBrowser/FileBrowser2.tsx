...
import { ProtoprocFile } from '../../../types/protoproc-types';
...
export const FileIcon: FunctionComponent<{fileName: string}> = ({fileName}) => {
    ...
    if (ext === 'py') {
        ...
        return <img src="/protoproc-logo.png" alt="logo" height={14} style={{paddingBottom: 0, cursor: 'pointer'}} />
    }
    else if (ext === 'nwb') {
