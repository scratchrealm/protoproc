        ...
        <span>
            <AppBar position="static" style={{height: applicationBarHeight - 10, color: 'black', background: '#e09050'}}>
                <Toolbar style={{minHeight: applicationBarHeight - 10}}>
                    <img src="/protoproc-logo.png" alt="logo" height={30} style={{paddingBottom: 5, cursor: 'pointer'}} onClick={onHome} />
                    <div onClick={onHome} style={{cursor: 'pointer'}}>&nbsp;&nbsp;&nbsp;Protoproc</div>
