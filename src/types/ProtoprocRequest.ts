import { isProtoprocProject, isProtoprocFile, isProtoprocComputeResource, isProtoprocJob, isProtoprocWorkspace, ProtoprocProject, ProtoprocFile, ProtoprocComputeResource, ProtoprocJob, ProtoprocWorkspace, ComputeResourceSpec, isComputeResourceSpec } from "./protoproc-types"
...
export type GetWorkspacesResponse = {
    type: 'getWorkspaces'
    workspaces: ProtoprocWorkspace[]
}

export const isGetWorkspacesResponse = (x: any): x is GetWorkspacesResponse => {
    return validateObject(x, {
        type: isEqualTo('getWorkspaces'),
        workspaces: isArrayOf(isProtoprocWorkspace)
    })
}
...
export const isGetFilesResponse = (x: any): x is GetFilesResponse => {
    return validateObject(x, {
        type: isEqualTo('getFiles'),
        files: isArrayOf(isProtoprocFile)
    })
}
...
export type GetComputeResourcesResponse = {
    type: 'getComputeResources'
    computeResources: ProtoprocComputeResource[]
}

export const isGetComputeResourcesResponse = (x: any): x is GetComputeResourcesResponse => {
    return validateObject(x, {
        type: isEqualTo('getComputeResources'),
        computeResources: isArrayOf(isProtoprocComputeResource)
    })
}
...
export type GetComputeResourceResponse = {
    type: 'getComputeResource'
    computeResource: ProtoprocComputeResource
}

export const isGetComputeResourceResponse = (x: any): x is GetComputeResourceResponse => {
    return validateObject(x, {
        type: isEqualTo('getComputeResource'),
        computeResource: isProtoprocComputeResource
    })
}
...
// ProtoprocRequestPayload

export type ProtoprocRequestPayload =
...
export const isProtoprocRequestPayload = (x: any): x is ProtoprocRequestPayload => {
    return isOneOf([
...
export type ProtoprocRequest = {
    payload: ProtoprocRequestPayload
    fromClientId?: string
    signature?: string
    userId?: string
...
export const isProtoprocRequest = (x: any): x is ProtoprocRequest => {
    return validateObject(x, {
        payload: isProtoprocRequestPayload,
...
export const isProtoprocResponse = (x: any): x is ProtoprocResponse => {
    return isOneOf([
